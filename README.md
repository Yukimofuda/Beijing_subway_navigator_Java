...
- 首页采用北京地铁复合字标、行程表单与线路预览；原背景图片保留。
- 站点选择、键盘操作、移动布局与旧方案待更新提示经过浏览器复核；预计出行时间包含首段候车。
- 原 SVG 共核验 **402 个可定位的注册表站点**，并隔离 15 个仅底图有的站点。站点总表仍完整保留 404 项，南八里庄、红庙没有原图位置，未绘制猜测点。
- [实现及截图](docs/frontend_refinement_2026-09.md) · [独立产品评审](docs/product_review_2026-09.md) · [SVG 逐站证据](docs/svg_mapping_investigation.md)
